...
const srcForm = document.querySelector('#search-form')
const eraseButton = document.querySelector('#erase-button')
const selectForm = document.querySelector('#filter-select')
...
selectForm.addEventListener('click', (e) => {
    ...
    todos.forEach((todo) => {
        ...
        else if(selectValue === 'done' && todo.className === 'todo done'){
            todo.style.display = 'flex'
        }
        else if(selectValue === 'todo' && todo.className === 'todo'){
            todo.style.display = 'flex'
        } else {
            todo.style.display = 'none'
        }
